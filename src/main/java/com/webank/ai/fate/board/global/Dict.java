...
public class Dict {
    ...
    static public final String URL_COPONENT_METRIC_DATA = "/v2/tracking/component/metric_data";
    static public final String URL_COPONENT_METRIC = "/v2/tracking/component/metrics";

    static public final String URL_COPONENT_PARAMETERS = "/v2/tracking/component/parameters";
    static public final String URL_DAG_DEPENDENCY = "/v2/job/dag/dependency";
    static public final String URL_OUTPUT_MODEL = "/v2/tracking/component/output/model";
    static public final String URL_OUTPUT_DATA = "/v2/tracking/component/output/data";
...
//    static public final String URL_JOB_DATAVIEW = "/v2/tracking/job/data_view";
    static public final String URL_JOB_DATAVIEW = "/v2/job/query";
    static public final String URL_JOB_LOG_PATH = "/v2/job/log/path";
    ...
    static public final String URL_LOG_SIZE = "/v2/log/size";
    static public final String URL_LOG_CAT = "/v2/log/cat";
    static public final String URL_CONFIG_CAT = "/v2/job/config";

    static public final String URL_FLOW_INFO = "/v2/server/fateflow/info";
